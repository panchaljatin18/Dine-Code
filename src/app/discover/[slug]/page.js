...
export default async function RestaurantDetailPage({ params, searchParams }) {
  ...
  if (!restaurant) {
    return (
      <div className="min-h-screen flex flex-col items-center justify-center bg-[var(--color-background)]">
        <h1 className="text-4xl font-playfair font-bold text-[var(--color-primary)] mb-4">
  ...
  return (
    <div className="min-h-screen bg-[var(--color-background)] pb-24">
      {/* Hero Section */}
      <div id="restaurantHero" className="relative h-[60vh] min-h-[400px] w-full">
        <Image
        ...
        <div className="absolute bottom-0 left-0 w-full pb-8 md:pb-16">
          <div className="luxury-container flex flex-col md:flex-row md:items-end justify-between gap-6">
            <div>
      ...
      {/* Content Section */}
      <div id="restaurantDetailsContainer" className="luxury-container mt-16">
        <div className="flex flex-col lg:flex-row gap-12">
          {/* Main Details */}
          <div className="lg:w-2/3">
            <section className="mb-12">
              <h2 className="text-3xl font-playfair font-bold text-[var(--color-primary)] mb-6">
                About
              </h2>
              <p className="text-lg text-gray-700 leading-relaxed">
                ...
                <br />
                <br />
                Nestled in the heart of {restaurant.location}, {restaurant.name}{" "}
                offers an unparalleled dining experience that brings together
                world-class culinary techniques and exquisite presentation.
                Whether you're planning a romantic dinner or a celebratory
                feast, our dedicated team ensures every moment is memorable.
              </p>
            </section>

            <section className="mb-12">
              <h2 className="text-2xl font-playfair font-bold text-[var(--color-primary)] mb-6">
              ...
              <div className="bg-[var(--color-secondary)]/5 border border-[var(--color-secondary)]/20 p-6 rounded-2xl flex items-start">
                ...
                <div>
                  ...
                  <p className="text-gray-600">
                    A signature creation by our executive chef, perfectly
                    balancing flavors and textures for an unforgettable bite.
            ...
            <section>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                {restaurant.features.map((feature) => (
                  <div
                    key={feature}
                    className="flex items-center text-gray-700 bg-white shadow-soft p-4 rounded-xl border border-gray-50">
          ...
          <div className="lg:w-1/3">
            <div className="sticky top-24 space-y-6">
              <div className="bg-white shadow-soft p-6 rounded-2xl border border-gray-100">
                <h3 className="font-bold text-[var(--color-primary)] text-lg mb-6 border-b border-gray-100 pb-4">
                  Info
                </h3>
                ...
                <div className="flex items-start mb-6">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600 text-sm leading-relaxed">
                      {restaurant.location}, Ahmedabad, Gujarat, India
                    </p>
                    <button className="text-[var(--color-secondary)] text-sm font-semibold mt-2 hover:underline">
                      Get Directions
                    </button>
                  </div>
                </div>
                ...
                {restaurant.priceForTwo && (
                  <div className="flex items-start mb-6">
                    <div className="w-5 h-5 text-[var(--color-secondary)] mr-4 shrink-0 mt-0.5 font-bold text-lg flex items-center justify-center">₹</div>
                    <div>
                      <p className="font-semibold text-gray-900 mb-1">Average Cost</p>
              ...
              <div className="bg-black text-white p-8 rounded-2xl text-center relative overflow-hidden">
                ...
                <div className="relative z-10">
                  ...
                  <p className="text-white/80 text-sm mb-6">
                    Secure your spot at {restaurant.name} for an unforgettable
                    dining experience.
                  </p>
                  <Button
                    variant="primary"
